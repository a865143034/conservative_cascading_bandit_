...
f1=open('file/u_1_test.txt', 'r')
f2=open('file/u_2_test.txt', 'r')
...
def plot_4(reg1,reg2,reg3,reg4,reg5):
    ...
    plt.ylim(0, 0.85)
    plt.xlim(0, 40000)
    plt.plot(reg1, 'g', label='u_0'+'=0.2', linewidth=2)
    plt.plot(reg2, color='coral', label='u_0'+'=0.5', linestyle='--', linewidth=2)
