...
plt.ylim(0, 7500)
plt.xlim(0, 40000)
plt.plot(reg2, 'g', label='C^4-UCB without known baseline reward', linestyle='--', linewidth=2)
#plt.plot(reg2, color='coral', label=chr(949)+'=0.1', linestyle='--', linewidth=2)
plt.plot(reg3, color='r',label='C^4-UCB without known baseline reward', linestyle='-.', linewidth=2)
plt.plot(reg1, color='coral', label='C^3-UCB', linewidth=2)
plt.legend( loc=1)
